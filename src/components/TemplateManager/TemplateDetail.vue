  ...
  <div class="template-detail" v-if="template">
    ...
    <div class="template-header">
      ...
      <div class="header-actions">
        <el-button @click="editTemplate" type="primary">
          ✏️ 编辑
        </el-button>
        <el-button @click="exportTemplate">
          📤 导出
        </el-button>
        <el-button @click="duplicateTemplate">
          📋 复制
        </el-button>
        <el-dropdown @command="handleMoreActions">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="validate">🧪 验证模板</el-dropdown-item>
              <el-dropdown-item command="refresh">🔄 刷新信息</el-dropdown-item>
              <el-dropdown-item command="delete" divided>🗑️ 删除模板</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </div>
          ...
          <div class="tab-content">
            ...
            <div class="stats-section">
              ...
              <div class="stats-grid">
                <div class="stat-item">
                  <div class="stat-value">{{ template.templateFiles?.length || 0 }}</div>
                ...
                <div class="stat-item">
                  <div class="stat-value">{{ formatDate(template.updatedAt) }}</div>
        ...
        <el-tab-pane label="👁️ 预览" name="preview">
          <div class="tab-content">
            <div class="preview-actions">
              ...
              <el-button @click="downloadPreview">
                📥 下载预览
              </el-button>
            </div>
